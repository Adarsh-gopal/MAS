...
class assets_report(models.AbstractModel):
    ...
    def get_header(self, options):
        ...
        return [
            ...
            [
                {'name': ''},  # Description
                {'name': _('Category'), 'class': 'text-center'},  # Characteristics
                # {'name': _('Model'), 'class': 'text-center'},  # Characteristics
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for al in parent_lines:
            ...
            line = {
                ...
                'columns': [
                    {'name': al['asset_category'] or ''},  # Characteristics
                    # {'name': al['asset_model'] or ''},  # Characteristics
    ...
    def _get_assets_lines(self, options):
        ...
        sql = """
                ...
                SELECT asset.id as asset_id,
                       ...
                       asset.asset_cat as asset_category,
