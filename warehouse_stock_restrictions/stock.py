...
class allow_warehouse(models.Model):
    ...
    @api.onchange('warehouse_loc_id')
    def set_analytic_and_journal(self):
        self.warehouse_id = self.warehouse_loc_id
        # self.analytic_account_id = self.warehouse_loc_id.analytic_account_id.id
        # self.l10n_in_journal_id = self.warehouse_loc_id.l10n_in_sale_journal_id.id